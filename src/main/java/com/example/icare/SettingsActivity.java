...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText userProfileStatus,userName,userFullName,userDob,userGender,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userProfileStatus = (EditText) findViewById(R.id.settings_profile_status);
        userName = (EditText) findViewById(R.id.settings_userName);
        userFullName = (EditText) findViewById(R.id.settings_Name);
        userDob = (EditText) findViewById(R.id.settings_dob);
        userPhoneNumber = (EditText) findViewById(R.id.settings_phone_number);
        userType = (EditText) findViewById(R.id.settings_User_type);
        ...
        /**Reads all info of user from the database (User Child) and display it*/
...
/** Sets an onclick listener to the update info button >>>> sends to validate Info method*/
...
/** Sets an onclick listener to the update image button >>>> opens gallery*/
    ...
    /**Validates the user info before its saved to the database*/
    ...
    private void UpdateAccInfo(String username, String fullname, String gender, String phonenumber, String profilestatus,
                               String dob, String relationshipstatus, String type, String country,String interest) {
 ...
 /**Send user to the main activity, after successfully updating their info*/
