...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Calls the method were layouts and variables were initialized*/
        Initialize();

        /** Calls the method that displays the message receiver information from the Database*/
        DisplayReceiverInfo();

        /** Calls the method that displays the messages from the Database*/
        FetchMessages();

        /**  Setting event listener to the Send message button and sends it to the send message method  */
...
/**  This method displays the messages between the send and the receiver from the database */
    ...
    private void Initialize() {
        ...
        /**  Getting the keys from the Friends Activity */
    ...
    private void SendMessage() {
        ...
        String messageText= chatMessageContent.getText().toString();
            if (TextUtils.isEmpty(messageText))
            {
                ...
                /** if the write msg textcbox is not empty, create a database that has the sender and receiver id as  the root*/
                {
...
/** Create a HashMap that stores information about the messgaes to the root child "Messages"*/
...
/**  Controls the users Status that stores their last seens to the database*/
...
/** Reads and display information of the receiver from the database , and updates the users Status*/
