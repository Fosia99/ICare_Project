...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** sets an onclick listener to the save info button >> sends to Save acc method*/
       ...
       /** Sets an onclick listener to the choose image button >>>> opens gallery*/
 ...
 private void SaveAccountSetUpInformation () {
    ...
    /**Send user to the main activity, after successfully  entering their info*/
